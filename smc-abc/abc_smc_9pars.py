...
from scoring_9_pars import score
...
def score_wrapper(log_k1: float,
                log_k2: float, log_k3: float, log_a1: float, log_a2: float, log_a3: float, log_n1: float, log_n2: float, log_n3: float) -> float:
...
def sequential_abc(initial_dist: float = 300.0,
                   final_dist: float = 5,
                   n_pars: int = 200,
