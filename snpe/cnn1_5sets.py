...
plt.savefig(f'6p-CNN1_set2.png')

### Save csv...
column_name = ['k1','k2','k3','a1','a2','a3']
cnn1_2r1k3p = pd.DataFrame(data=posterior_samples_cnn1, columns=column_name)
cnn1_2r1k3p.to_csv('cnn1_6p_set2.csv')
...
plt.savefig(f'6p-CNN1_set3.png')

### Save csv...
column_name = ['k1','k2','k3','a1','a2','a3']
cnn1_2r1k3p = pd.DataFrame(data=posterior_samples_cnn1, columns=column_name)
cnn1_2r1k3p.to_csv('cnn1_6p_set3.csv')
...
plt.savefig(f'6p-CNN1_set4.png')

### Save csv...
column_name = ['k1','k2','k3','a1','a2','a3']
cnn1_2r1k3p = pd.DataFrame(data=posterior_samples_cnn1, columns=column_name)
cnn1_2r1k3p.to_csv('cnn1_6p_set4.csv')
...
plt.savefig(f'6p-CNN1_set5.png')

### Save csv...
column_name = ['k1','k2','k3','a1','a2','a3']
cnn1_2r1k3p = pd.DataFrame(data=posterior_samples_cnn1, columns=column_name)
cnn1_2r1k3p.to_csv('cnn1_6p_set5.csv')