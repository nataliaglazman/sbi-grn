...
prior = utils.BoxUniform(
    low=torch.tensor([10**-2,10**-2,10**-2, 20., 20., 20., 0.,0.,0.,1.,1.,1.,10**-2,10**-2,10**-2]),
    high=torch.tensor([250.,250.,250.,40.,40.,40.,5.,5.,5.,5.,5.,5.,50.,50.,50.]))
...
headers = ["k1", "k2", "k3", "a1", "a2", "a3", 
           "g1", "g2", "g3", "n1", "n2", "n3", 
           "b1", "b2", "b3"]          # parameters to be inferred
num_timesteps = 100
...
cnn1_2r1k3p.to_csv('ss_15p_set2.csv')
