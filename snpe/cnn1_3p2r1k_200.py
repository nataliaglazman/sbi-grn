...
_ = analysis.pairplot(
    posterior_samples_cnn1, limits=[[-100, 300], [-100, 300], [-100, 300]], figsize=(6, 6) #It should be close to 247, but since this is a toy example we are not expecting it to work (just checking it runs).
)

plt.savefig(f'3p-2r-1500s-CNN1_200.png')

### Save csv...
column_name = ['k1','k2','k3']
cnn1_2r1k3p = pd.DataFrame(data=posterior_samples_cnn1, columns=column_name)
cnn1_2r1k3p.to_csv('cnn1_2r1k3p_200.csv')
